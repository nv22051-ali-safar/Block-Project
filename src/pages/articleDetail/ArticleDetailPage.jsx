...
const postsData = [
    {
        ...
        title: "Hep children get better education",
        createdAt: '2023-01-28T15:35:35:53.607+0000'
    },
    {
        _id: "2",
        image: images.Post1Image,
        ...
        <MainLayout>
            <section className='container mx-auto max-w-5xl flex flex-col px-5 py-5 lg:flex-row lg:gap-x-5 lg:items-start'>
                <article className='flex-1'>
                    ...
                    <Link to="/blog?category=selectedCategory" className="text-primary text-sm font-roboto inline-block mt-4md:text-base" >
                        EDUCATION
                    </Link>
                    <h1 className='text-xl font-medium font-roboto mt-4 text-dark-hard md:text-[26px]'>
                        Help children get better educatoion
                    </h1>

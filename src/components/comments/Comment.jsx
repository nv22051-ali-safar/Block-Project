...
const Comment = ({ comment, loggiendUserId, affectedComment, setAffectedComment, addComment, parentId = null, updateComment, deleteComment, replies, }) => {
    const isUserLoggined = Boolean(loggiendUserId);
    const commentBelongsToUser = loggiendUserId === comment.user._id;
    const isReplying =
        affectedComment && affectedComment.type === "replying"
        && affectedComment._id === comment._id;
    const isEditing =
        affectedComment && affectedComment.type === "editing"
        && affectedComment._id === comment._id;
    ...
    return (
        <div className='flex flex-nowrap items-start gap-x-3 bg-[#F2F4F5] p-3 rounded-lg'>
            ...
            <div className='flex-1 flex flex-col'>
                ...
                {isEditing && (
                    <CommentForm btnLabel="Update" formSubmitHanlder={(value) =>
